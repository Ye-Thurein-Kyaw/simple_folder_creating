...
void main() {
  ...
  final baseDir = Directory(p.join(basePath, folderName));
  ...
  group('Folder Structure Generator', () {
    ...
    test('Ensure subfolders are created', () {
      ...
      for (var subfolder in subfolders) {
        final subfolderPath = Directory(p.join(baseDir.path, subfolder));
    ...
    test('Ensure files are created with content', () {
      ...
      subfolders.forEach((subfolder, filePath) {
        final file = File(p.join(baseDir.path, filePath));
